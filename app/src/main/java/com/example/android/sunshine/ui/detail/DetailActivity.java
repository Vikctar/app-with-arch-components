    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppExecutors.getInstance().diskIO().execute(()-> {
            try {
                ...
                WeatherEntry mockWeatherFromDatabase = new WeatherEntry(1, 210, today,
                        88.0, 99.0, 71, 1030, 74, 5);
                mViewModel.setWeather(mockWeatherFromDatabase);

                Thread.sleep(2000);
                mockWeatherFromDatabase = new WeatherEntry(1, 952, today,50.0,
                        60.0,46,1044, 70, 100);
                mViewModel.setWeather(mockWeatherFromDatabase);
